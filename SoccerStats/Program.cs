...
namespace SoccerStats
{
    ...
    public static string ReadFile(string fileName)
        ...
        public static List<NewsResult> GetNewsForPlayer(string playerName)
        {
            ...
            var webClient = new WebClient();
            webClient.Headers.Add("Ocp - Apim - Subscription - Key", "7e6b105dcff14efaba5b645df5594eda");
        ...
        public static SentimentResponse GetSentimentResponse(List<NewsResult> newsResults)
        {
            ...
            var webClient = new WebClient();
            webClient.Headers.Add("Ocp - Apim - Subscription - Key", "b9c39eca5da14a95b06f3f116866c2be");
